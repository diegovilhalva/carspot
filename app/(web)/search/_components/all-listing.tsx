...
import { CarFrontIcon, FilterIcon } from "lucide-react"
import { useState } from "react"

const AllListings = ({ listings, isPending, onFilterOpen }: { listings: ListingType[], isPending: boolean, onFilterOpen: () => void }) => {
