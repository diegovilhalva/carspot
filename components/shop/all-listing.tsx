...
const AllListing = ({ listings, isPending }: { listings: ListingType[], isPending: boolean }) => {
    const [layout, setLayout] = useState<"list" | "grid">("grid")
    return (
        <Card className="shadow-none !bg-transparent rounded-[8px]
    border-none min-h-56">
            <CardContent className="p-3">
                ...
                <div
                    className={`w-full grid ${layout === "list"
                            ? "grid-cols-1 gap-4"
